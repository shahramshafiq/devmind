        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.5fr', gap: 32, alignItems: 'start' }}>
          ...
          >
            ...
            <div style={{
              ...
              <a href="mailto:shahramshafiqgoraya4363@gmail.com" style={{
          ...
          >
            ...
            <div style={{
              ...
              <p style={{
                ...
                My focus is on <strong style={{ color: '#ffffff', fontWeight: 600 }}>agentic AI</strong> and developer automation — systems where multiple AI agents collaborate to complete complex, real-world engineering tasks without human intervention.
              </p>
              <p style={{
                fontSize: 16, lineHeight: 1.8,
                color: 'rgba(255,255,255,0.6)',
              }}>
                DevMind started as a semester project and turned into a full multi-agent system using LangGraph, FastAPI, ChromaDB, and Groq — capable of analyzing codebases and opening real GitHub pull requests autonomously.
              </p>
            </div>
